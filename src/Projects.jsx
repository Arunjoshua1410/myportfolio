      ...
      return (
        <>
          <div className="project row">
            ...
            <div className="frame col-4 d-flex justify-content-center">
              <iframe
                src="https://tamilnaduebbillcalculatorhome.netlify.app/"
                title="Tamil Nadu EB Bill Calculator Project"
                frameBorder="0"
                width="800px"
                height="500px"
              ></iframe>
            ...
            <div className="ebbill col-4 d-flex justify-content-center">
              <iframe
                src="https://bodymassindexproject.netlify.app/"
                title="Body Mass Index Project"
                frameBorder="0"
                width="800px"
                height="500px"
              ></iframe>
            ...
            <div className="ebbillbt col-4">
              <iframe
                src="https://spicyhuttwebsite.netlify.app/"
                title="Spicy Hutt Website Project"
                frameBorder="0"
                width="800px"
                height="500px"
              ></iframe>
            ...
            <div className="bmi col-4">
              <h6>To see the Full View Of the site Click the Button</h6>
              <button>
                <a href="https://tamilnaduebbillcalculatorhome.netlify.app/" target="_blank" rel="noopener noreferrer" className="btn-link">
                  EB Bill project
                </a>
              </button>
            </div>
            <div className="bmi col-4">
              <h6>To see the Full View Of the site Click the Button</h6>
              <button>
                <a href="https://bodymassindexproject.netlify.app" target="_blank" rel="noopener noreferrer" className="btn-link">
            ...
            <div className="bmi col-4">
              <h6>To see the Full View Of the site Click the Button</h6>
              <button>
                <a href="https://spicyhuttwebsite.netlify.app/" target="_blank" rel="noopener noreferrer" className="btn-link">
                  Commercial project
                </a>
              </button>
            </div>
