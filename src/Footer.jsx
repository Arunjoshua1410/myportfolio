      ...
      <>
         <div className="row footer">
              ...
              <div className="linked col-3 d-flex justify-content-center" >
                  <a href="https://www.linkedin.com/in/arun-pandiyan-927081238/" target="_blank" rel="noreferrer"><i className="fa-brands fa-linkedin fa-2xl" style={{color:"rgba(9, 132, 227,1.0)"}}></i></a>
              </div>
              <div className="github col-3 d-flex justify-content-center">
                  <a href="https://github.com/Arunjoshua1410" target="_blank" rel="noreferrer"><i className="fa-brands fa-github fa-2xl" style={{color:"#000"}}></i></a>
              </div>
              <div className="whatsapp col-3 d-flex justify-content-center" >
                  <a href="https://wa.me/918838574431" target="_blank" rel="noreferrer"><i className="fa-brands fa-whatsapp fa-2xl" style={{color:"rgba(39, 174, 96,1.0)"}}></i></a>
              </div>
